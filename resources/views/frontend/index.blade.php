                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            ...
                            <p>
                                Hurry! Don't miss out on our limited-time offer for CocoCare. Shop now and experience the
                                power of sustainable shopping before the deal runs out. Make a positive impact on the
                                environment with every purchase. Act fast and join us in creating a greener future!
                            </p>
                            <div class="container">
                                ...
                                <a href="{{ route('product-grids') }}" class="btn" style="color: white;">check out
                                    deal</a>
                            </div>
                            <div class="image">
