                        ...
                        <div class="right-content">
                            <ul class="list-main">
                                ...
                                @auth
                                    ...
                                    @else
                                    <li><i class="fa fa-truck"></i> <a href="{{route('cart')}}">Add to llCart</a><i class="fa fa-truck"></i> <a href="{{route('order.track')}}">Track Order</a><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">Dashboard</a>
                                    @endif
