    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
            ...
            <input id="expiration_date" type="date" name="expiration_date" placeholder="Enter expiration date" value="{{ old('expiration_date') }}" class="form-control">
        ...
        <div class="form-group">
            ...
            <input id="manufactured_date" type="date" name="manufactured_date" placeholder="Enter manufactured date" value="{{ old('manufactured_date') }}" class="form-control">
